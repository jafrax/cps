    ...
    public void save(){
         ...
         try {
        	 ...
        	 String qry = " insert into "+Libs.getDbName()+".dbo.suplier (kode,nama,perusahaan,"
             		+ "alamat1,alamat2,kota,kodepos,telp,fax,"
             		+ "ledate,leuser,tdkpakai,data_ts,prnt_ts,tempobyr) "
             		+ "values "
             		+ "('"+code.getText()+"','"+nama.getText()+"','"+perusahaan.getText()+"',"
             		+ "'"+alamat1.getText()+"','"+alamat2.getText()+"','"+kota.getText()+"','"+pos.getText()+"','"+telp.getText()+"','"+fax.getText()+"',"
             		+ "getdate(),'user',0,0,0,'"+tempo.getText()+"');";
