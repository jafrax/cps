...
public class DataJualController extends Window {

    private Logger log = LoggerFactory.getLogger(DataJualController.class);
    private Listbox lb;
    ...
    private void populate(int offset, int limit) {
        ...
        try {
            ...
            String q1 = "select no_nota, tgl_nota,tgl_tempo,no_order kd_cust, kd_kategori, total ";
            String q2 = "from "+Libs.getDbName()+".dbo.beli ";
            String q3 = "";
            String q4 = "order by no_nota asc ";
    ...
    public void DetailSelected() {
        ...
        Session s = Libs.sfDB.openSession();
        try {
            String q1 = "select no_nota, kd_barang, banyak, hargaperbrg, hpp, disc_rp, disc_pc, kodelok ";
