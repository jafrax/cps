...
public class EditSuplierController extends Window {
    ...
    private void isi(){
    	 ...
    	 kode = (String) getAttribute("kode");
         toko = (String) getAttribute("toko");
         ...
         try {
             ...
             String q2 = "from "+Libs.getDbName()+".dbo.suplier where kode = '"+code.getText()+"' ";
            
             //Messagebox.show("query : " +q1 + q2);
