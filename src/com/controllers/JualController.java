...
public class JualController extends Window {

    private Logger log = LoggerFactory.getLogger(JualController.class);
    ...
    private Combobox sales;
    
    private Datebox faktur;
    ...
    private void initComponents() {
    	 sales = (Combobox) getFellow("sales");
