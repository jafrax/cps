...
public class OrderJualController extends Window {

    private Logger log = LoggerFactory.getLogger(OrderJualController.class);
    private Listbox lb;
    ...
    private void populate(int offset, int limit) {
        ...
        try {
            ...
            String q1 = "select no_order, tgl_order,tgl_tempo, kd_kategori, kd_cust, transaksi, total,check_spv,kd_sales ";
            String q2 = "from "+Libs.getDbName()+".dbo.salesorder ";
            String q3 = " where check_spv = 1 ";
            ...
            for (Object[] o : l) {
                ...
                String namatoko = Libs.findToko(Libs.nn(o[4]));
                ...
                int ch = Integer.parseInt(((String)Libs.nn(o[7])));
                String Check = "";
