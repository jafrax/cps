...
public class KomisiSalesController extends Window {
    ...
    private void populate(int offset, int limit) {
        ...
        try {
            ...
            String q1 = "select "
                    + " a.kd_sales,b.nama as nama_sales,a.kd_kategori,c.nama as keterangan,a.komisi,a.kom1,a.kom2,a.kom3,a.kom4,a.kom5,a.kom6 ";
    ...
    public void Input() {
    	Window w = (Window) Executions.createComponents("views/InputKomisi.zul", this, null);
        w.doModal();
    }
