...
//    	    	System.out.println("total "+ sql);	
    ...
    public static void getsatuan(Combobox cb){
    	...
    	cb.appendItem("BIJI"); cb.appendItem("BNGKS");  cb.appendItem("BOTOL"); cb.appendItem("BOX"); cb.appendItem("BUAH");cb.appendItem("BUAH");cb.appendItem("BUKU");
    	cb.appendItem("CM2");cb.appendItem("CM3");cb.appendItem("CC");cb.appendItem("CM");cb.appendItem("CONTR");cb.appendItem("DUS");cb.appendItem("DRUM");
    	cb.appendItem("EKOR");cb.appendItem("FOLIO");cb.appendItem("GROSS");cb.appendItem("GRAM");cb.appendItem("KANTG");cb.appendItem("KAPLT");cb.appendItem("KAPSL");
    	cb.appendItem("KG");cb.appendItem("KUBIK");cb.appendItem("LBR");cb.appendItem("LINE");cb.appendItem("LITER");cb.appendItem("LUSIN");cb.appendItem("M2");
    	cb.appendItem("M3");cb.appendItem("METER");cb.appendItem("ML");cb.appendItem("MOBIL");cb.appendItem("ONS");cb.appendItem("ORANG");cb.appendItem("OZ");
    	cb.appendItem("PACK");cb.appendItem("PCS");cb.appendItem("PIECE");cb.appendItem("PLANO");cb.appendItem("PLSTK");cb.appendItem("PSNG");cb.appendItem("RIM");
    	cb.appendItem("ROLL");cb.appendItem("ROOM");cb.appendItem("SET");cb.appendItem("STEL");cb.appendItem("STRIP");cb.appendItem("TABLT");cb.appendItem("TABNG");
    	cb.appendItem("TRUK");cb.appendItem("UNIT");cb.appendItem("ZAK");
    ...
    public static String setKategori(String kode){
  	  ...
  	  Session s = Libs.sfDB.openSession();
  	  try{
  	    	String sql = "Select * from " +Libs.getDbName()+".dbo.kategori where tdkpakai=0  and kode = '"+kode+"' ";
  	    	SQLQuery query = s.createSQLQuery(sql);
  	    	List<Object[]> l = query.list();
  	    	for(Object[] o : l){
  	    		result = Libs.nn(o[1]).trim() + "("+ Libs.nn(o[0]).trim() + ")";
  	    	}
  	   
  	  }catch(Exception e){
  	    		log.error("setKategori", e);
  	  }finally{
  	  	if(s != null && s.isOpen()) s.close();
  	  }
  	 return result ;
...
//	  	    	System.out.println(sql);
    ...
    public static String totalPlafon(String kode_kota, String kode_toko){
		Session s = Libs.sfDB.openSession();
    	String result ="0";
    	  try{
...
//	  	    	System.out.println(sql);
    ...
    public static String nextnumber(String kota){
    	...
    	String result ="";
    	  try{
	  	    	String sql = "Select isnull(max(kode_toko),0) as number , 0 from " +Libs.getDbName()+".dbo.toko where kode_kota='"+kota+"'  ";
